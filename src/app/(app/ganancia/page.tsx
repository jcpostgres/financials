        ...
        <div className="space-y-4">
          <Card className="bg-muted/30">
            ...
            <CardContent>
              ...
              <div className="mt-4">
                <h3 className="text-sm font-semibold mb-2">Desglose por Socio:</h3>
                <ul className="space-y-2">
                {partners.map(p => (
                  <li key={p.name} className="flex items-center justify-between p-2 bg-background rounded-md text-sm">
